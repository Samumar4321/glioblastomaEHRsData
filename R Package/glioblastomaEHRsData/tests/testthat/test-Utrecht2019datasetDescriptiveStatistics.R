...
test_that("Utrecht2019datasetDescriptiveStatistics(show = 'continuous') return the correct summarytools object", {
  ...
  expect_setequal(labels(stats)[[2]], c("age_years", "OS_months"))
})
...
test_that("Utrecht2019datasetDescriptiveStatistics(show = '') throws and return a warning", {
  expect_warning(Utrecht2019datasetDescriptiveStatistics(show = ""))
})
